...
Пулл (фетч + мерж), Пуш, Коммит, указатель HEAD, чекаут, ветки (бренч), мерж, ребейз, теги, релизы  
...
При возникновении проблемы "не хватает места на диске" при том, что оно есть одной из причин может быть то, что закончились Inode.  
